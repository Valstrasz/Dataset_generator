...
###### MAIN ######
##################
def commonDirTrainValid(destination_relativity):
    # CREATION VARIABLES
    list_train = []
    list_valid = []

    ### SELECTION ELIGIBLE FILES ###
    # Populating the list containing the paths to the IMAGES
    list_dir_im_instruction = "\nEnter the path(s) to the directories containing the IMAGES you want in your datasets:"
    list_dir_im = askUserSuccessivePaths(list_dir_im_instruction)
    # Populating the list containing the paths to the LABELS
    list_dir_lab_instruction = "\nEnter the path(s) to the directories containing the LABELS you want in your datasets:"
    list_dir_lab = askUserSuccessivePaths(list_dir_lab_instruction)
    # Populating the list containing the paths for the couples ([images, labels]) of ELIGIBLE files
    list_eli = listImageLabelSameRootname(list_dir_im, list_dir_lab)
    ...
    list_train = generatePhaseDataset(list_train_instruction, list_eli)
    ...
    list_valid = generatePhaseDataset(list_valid_instruction, list_eli)
    ...
    classes_file_ori = findFileWithinListDir("classes.txt", list_dir_lab)
